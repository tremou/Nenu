#It plots the elevation and the sepration distance between A-team sources and the phase center of the observations (pointing). 
...
#The difference is that the current script could be used before the obseervations in order to avoid certain proximity of an A-team source. This can help avoiding the heavy computing demixing-process (https://support.astron.nl/LOFARImagingCookbook/tutorial.html#flagging-and-demixing) 
#!/usr/bin/python
